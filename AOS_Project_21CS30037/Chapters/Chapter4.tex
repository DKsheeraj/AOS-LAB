...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{Pictures/monarch.png} % Replace with your image name
    \caption{Overview of Monarch \cite{50652}}
\end{figure}

\subsection*{State-Holding Components}
...
\subsection*{Data Ingestion Components}
...
\subsection*{Query Execution Components}
...
\subsection*{Targets (Monitored Entities)}
\begin{itemize}
...
\subsection*{Metrics (What We’re Measuring)}
\begin{itemize}
...
\section{How Data Storage Happens}
