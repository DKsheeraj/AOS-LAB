...
\datesub{November 3, 2024}
\datesig{November 3, 2024}
\semsub{Autumn Semester, 2024-25}
\keywords{Monarch}
\coursecd{Study Report}
...
\begin{titlepage}
    ...
    {\huge \bfseries A Study Report On}
    
    \vspace{1.5cm}
    
    {\LARGE \bfseries Monarch: Google’s Planet-Scale In-Memory Time Series Database}
    ...
    {\Large \bfseries Datta Ksheeraj}
    
    \vspace{0.5cm}
    
    {\Large \bfseries 21CS30037}
