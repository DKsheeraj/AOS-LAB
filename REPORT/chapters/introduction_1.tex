\section{Overview: What is Tectonic?}\label{sec:intro}
...
\section{Meta's Existing Storage Systems}\label{sec:existing}

Meta's storage infrastructure mainly serves two types of tenants: Blob Storage and Data Warehouse.

\subsection{Blob Storage}\label{sec:blob_storage}
...
\subsection{Data Warehouse}\label{sec:data_warehouse}
